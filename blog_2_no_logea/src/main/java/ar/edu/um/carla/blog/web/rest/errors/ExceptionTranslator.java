package ar.edu.um.carla.blog.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler implements ExceptionTranslation {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof ar.edu.um.carla.blog.service.EmailAlreadyUsedException ||
            ex instanceof ar.edu.um.carla.blog.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof ar.edu.um.carla.blog.service.InvalidPasswordException
